...
<head>
    ...
    <script src="<?php echo e(asset('js/caixa.js')); ?>"></script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('userLogin')); ?>"><?php echo e(__('Login')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('userRegister')); ?>"><?php echo e(__('Registrar')); ?></a>
                        </li>
                        ...
                        <?php elseif(\Request::is('usuario/register')): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('userLogin')); ?>"><?php echo e(__('Login')); ?></a>
                        </li>
                        <li class="nav-item">
...
<?php /**PATH /home/thiago/Desktop/lab/resources/views/layouts/app.blade.php ENDPATH**/ ?>