...
<div class="container" >
  <div class="row justify-content-center">
    <input type="hidden" value="<?php echo e($id); ?>" id="id_sala">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aluno): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($aluno->name); ?></td>
                  <td>
                    <?php echo e($aluno->email); ?>


                  </td>
                  <td>
<!--
                    <a class="nav-link" onclick="(confirm('Você realmente deseja deletar o(a) aluno(a) \'<?php echo e($aluno->name); ?>\'? ')) ? window.location.href =  '<?php echo e(url('admin/deletar-aluno/'.$aluno->id.'/'.$id)); ?>' : window.location.reload(forcedReload);">
...
-->
                      ...
                      <a data-toggle="modal" style="cursor: pointer" data-target="#removerAlunoModal" data-id="<?php echo e($aluno->id); ?>" data-nome="<?php echo e($aluno->name); ?>" data-sala="<?php echo e($id); ?>" class="dropdown-item" id="<?php echo e('aluno'.$aluno->id); ?>"><i class="material-icons">clear</i></a>
                  </td>
                </tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <input type="hidden" name="sala_id" id="sala_id" value="<?php echo e($id); ?>">
  ...
  <div class="modal fade bd-example-modal-lg " id="addNovoAlunoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo e(url('/admin/new/email')); ?>" method="POST" style="margin-left: 5%;margin-right:1%;margin-top:3%">
          <?php echo csrf_field(); ?>
          <div class="modal-body">
            <input type="hidden" name="sala_id" id="sala_id" value="<?php echo e($id); ?>">
            <div class="form-group" style="margin-top:3.5%">
...
<?php echo $__env->make('vendor.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thiago/Desktop/lab/resources/views/add_alunos.blade.php ENDPATH**/ ?>